...
import adminPanel.model.AddProjects;
...
public class AddProjectsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String brokerDetails=request.getParameter("brokerId");
        ...
        boolean isAdd = false;
        isAdd = addProj.isAdded(name, desc, imageName, status,brokerDetails,buyer,seller);
